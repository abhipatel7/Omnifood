...
<section class="section-steps" id="work">
    ...
    <div class="row">
        <div class="col span-1-of-2 step-box">
            <img class="app-screen js--wp-2" src="resources/img/app-iPhone.png" alt="Omnifood iPhone App">
        </div>
        <div class="col span-1-of-2 step-box">
            <div class="work-step">
                <div>1</div>
...
<section class="section-testimonials">
    ...
    <div class="row">
        ...
        <div class="col span-1-of-3">
            ...
            <cite>
                <img src="resources/img/customer-2.jpg" alt="Customer 2">
                Joana Silva
            </cite>
        </div>
        <div class="col span-1-of-3">
            ...
            <cite>
                <img src="resources/img/customer-3.jpg" alt="Customer 3">
                Milton Chapman
            </cite>
        </div>
    </div>
...
<section class="section-plans js--section-plans" id="plan">
    <div class="row">
